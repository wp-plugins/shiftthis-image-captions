...
Features: 
 * Javascript dynamically puts an image in a div with the alt text as the caption below.  Alt & Title attributes are removed for reduntancy.  Caption is not displayed if no alt text is present or if alt text matches the image name.
...
function stic_img_js($content){
		 $add_js = '/(\<img)/';  
	     $html = '<img onload="javascript:addImgCaption(this);"';
		// string replacement.
